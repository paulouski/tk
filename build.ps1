# tk build script — for developers building from source
...
dotnet publish Tk.csproj -c Release -r win-x64 --self-contained false -p:PublishSingleFile=true -o $installDir --nologo -v quiet
