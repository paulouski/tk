...
/// </summary>
public record DaemonRequest(string Method, string? FilePath, int Line, int Character, string? Symbol);

/// <summary>
/// Response from the LSP daemon.
/// </summary>
public record DaemonResponse(bool Success, string? Error, LspLocation[]? Locations);
